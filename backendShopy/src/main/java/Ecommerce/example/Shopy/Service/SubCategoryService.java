...
public class SubCategoryService {
    ...
    public ResponseEntity<ResponseAPI<SubCategory>> saveOrUpdateSubCategory(SubCategory subCategory, String successMessage)
    {
        SubCategory savedSubCategory = subCategoryRepository.save(subCategory);
        return globalRESTAPIHandler.createResponse(successMessage, HttpStatus.OK, subCategory);
    }

    public ResponseEntity<ResponseAPI<String>> deleteSubCategory(SubCategory subCategory) {
