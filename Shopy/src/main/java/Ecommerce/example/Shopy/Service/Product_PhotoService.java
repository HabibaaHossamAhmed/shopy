...
public class Product_PhotoService {
    ...
    public ResponseEntity<Response<Product_Photo>> saveOrUpdateProductPhoto(Product_Photo productPhoto, String
            successMessage) {
    ...
    public ResponseEntity<Response<String>> deleteProductPhoto(Product_Photo productPhoto) {
